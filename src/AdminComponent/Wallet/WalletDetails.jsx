...
const handleFetchUserWalletTransaction = (WalletId) =>{
	dispatch(
		//getTransactionsByWalletId({jwt,WalletId}),
		...
		<>
         ...
         <Card>
            <div className="pb-9">
				...
				<Button variant="outlined" color="primary"onClick={handleClickToWithdrawalOpen}>Withdrawal</Button>
			        <Dialog  open={openWithdrawal} onClose={handleClickToWithdrawalClose}>
				       <div className="h-250 w-250 hover:text-gray-400 cursor-pointer 
			            	flex flex-col items-cetner justify-center rounded-md ">       
								<DialogContent>
				     					<DialogTitle>Withdrawal Form Details</DialogTitle>
					    						 <WithdrawalForm/>
								</DialogContent>
						</div>
					</Dialog>
