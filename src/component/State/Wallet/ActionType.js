...
export const GET_WALLET_ALL_TRANSACTION_REQUEST = "GET_WALLET_ALL_TRANSACTION_REQUEST";
export const GET_WALLET_ALL_TRANSACTION_SUCCESS = "GET_WALLET_ALL_TRANSACTION_SUCCESS";
export const GET_WALLET_ALL_TRANSACTION_FAILURE = "GET_WALLET_ALL_TRANSACTION_FAILURE";
